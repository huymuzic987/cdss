...
const PATIENT_PRESET_DEFINITIONS: PatientPresetDefinition[] = [
  ...
  },
  {
    ...
    category: PREGNANCY,
    description: 'Preeclampsia after week 20 with severe headache and visual disturbance — routes through the eclampsia severe-signs branch to the labetalol/nicardipine plus MgSO4 alternatives, ending in emergency delivery because the immediate treatment target is not met.',
    data: {
  ...
  },
  {
    ...
    category: PREGNANCY,
    description: 'Normotensive pregnancy with a high-preeclampsia-risk flag — the prophylaxis check runs before hypertension classification and prescribes aspirin from weeks 12–36.',
    data: {
      clinic_1_sbp: '130', clinic_1_dbp: '80',
      age: '28', risk_factor_count: '1',
      is_pregnant: true,
